...
Function key, app-level auth, and token-aware API design for Java-triggered endpoints.
...
```java
@FunctionName("HTTPAuthentication")
public HttpResponseMessage run(
    ...
    context.getLogger().info("recipe=http-auth.md id=" + id);
