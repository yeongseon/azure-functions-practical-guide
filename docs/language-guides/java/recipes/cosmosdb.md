...
Read and write Azure Cosmos DB documents from Java functions with resilient connection handling.
...
```java
@FunctionName("CosmosDBIntegration")
public HttpResponseMessage run(
    ...
    context.getLogger().info("recipe=cosmosdb.md id=" + id);
