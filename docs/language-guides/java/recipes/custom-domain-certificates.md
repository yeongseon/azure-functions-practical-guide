...
Bind custom domains and TLS certificates for production Java APIs on Functions.
...
```java
@FunctionName("CustomDomainCertificates")
public HttpResponseMessage run(
    ...
    context.getLogger().info("recipe=custom-domain-certificates.md id=" + id);
