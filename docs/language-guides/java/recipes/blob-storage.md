...
Use blob triggers and outputs for ingestion, transformation, and archival pipelines.
...
```java
@FunctionName("BlobStorageIntegration")
public HttpResponseMessage run(
    ...
    context.getLogger().info("recipe=blob-storage.md id=" + id);
