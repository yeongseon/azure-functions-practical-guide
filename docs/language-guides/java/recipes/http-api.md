...
Route design, request validation, response shaping, and status code discipline for Java HTTP handlers.
...
public HttpResponseMessage run(
    ...
    context.getLogger().info("recipe=http-api.md id=" + id);
