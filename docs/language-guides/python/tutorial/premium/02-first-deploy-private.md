...
# 02 - First Deploy (Private Networking)
...
!!! note "Looking for a simpler first deploy?"
    This tutorial covers **complete private networking** setup. For a quick public deployment, see [02 - First Deploy](02-first-deploy.md).
