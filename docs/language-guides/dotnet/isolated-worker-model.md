...
content_sources:
  ...
  diagrams:
    - id: why-isolated-worker-is-the-default
      type: flowchart
      source: self-generated
      justification: Flow view of why isolated worker is the default, synthesized from Microsoft Learn documentation cited on this page.
      based_on:
