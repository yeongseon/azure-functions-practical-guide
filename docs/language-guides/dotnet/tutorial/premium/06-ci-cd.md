...
Automate build and deployment for Premium with GitHub Actions, deterministic .NET builds, and publish-profile based release flow.
...
- A GitHub Actions workflow that builds and deploys your Premium Function App
...
```yaml
name: Deploy .NET Function App (Premium)
