...
Automate build and deployment for Dedicated with GitHub Actions, deterministic .NET builds, and publish-profile based release flow.
...
```yaml
name: Deploy .NET Function App (Dedicated)
